...
## Accepted foundation | WorkOrder #43 file input and minimal repair
...
WorkOrder #34 received an independent [accepted Verdict](https://github.com/pym96/Pan-agent/issues/34#issuecomment-5566786233), including Human P-D6 review, and landed unchanged at `13d659a7292748f7f01dd592aa417848917d9065`. `typescript/` is **Product**, with no Pi runtime or development dependency; `references/pi/` is independently installed **Frozen Reference**. Product omission is `kernel_selection_required`, explicit Pi is `kernel_not_in_product`; the reference retains its prior Pi selection behavior. The [transition decision](../adr/0017-product-isolation-and-frozen-pi.md) and [split inventory](../design/product-isolation.md) retain that decision and its coverage evidence. #35 preserves the accepted core and reference bytes.
...
WorkOrder #24 made TypeScript/Pi the authoritative product, retained Python as reference-only, and classified older mechanism/evaluation lanes as experiment/reference. The Bash-only ReAct lane is retired as an active mission. Its accepted candidate landed at `255da3c043bdddde28b5f94d549725edddee2ff6`; WorkOrder #28 does not reopen that decision or modify its historical Evidence.
