...
- [`pan-faux-and-trusted-local-tools.md`](pan-faux-and-trusted-local-tools.md): WorkOrder #32's Builder candidate for a reusable deterministic Pan Faux Adapter and direct Pan-owned trusted-local read/write/edit/bash Tools on explicit Native composition.
