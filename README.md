...
- [`docs/design/deepseek-live-budgeted-serial-runner.md`](docs/design/deepseek-live-budgeted-serial-runner.md): WorkOrder #11 Stage A-R's independently accepted sole budgeted serial campaign runner, typed dispatch settlement, repaired execution identity, exact acknowledgement Gate, and zero-call reconstruction boundary; Stage B remains suspended with no live call or balance query;
