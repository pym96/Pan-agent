...
historical=a.output/'historical-42';subprocess.run(['git','worktree','add','--detach',str(historical),base],cwd=root,check=True,stdout=subprocess.PIPE);(historical/'typescript/node_modules').symlink_to(root/'typescript/node_modules',target_is_directory=True)
