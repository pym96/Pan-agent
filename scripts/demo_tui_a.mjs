...
console.log('OFFLINE TUI A · installed Product · Faux only. Confirm y; @ selects; Ctrl-P previews; separate Enter sends.');console.log('During the 8-second response, edit next draft; Ctrl-C cancels once. Ctrl-V safe paste/edit; Esc exits it. :exit closes.');console.log('Local recording directory: '+root);
