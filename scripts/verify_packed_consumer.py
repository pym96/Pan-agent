#!/usr/bin/env python3
"""#35 source→compiled tarball→production consumer proof, on the declared Node floor.
...
for source,name in [('scripts/wo35-consumer-guard.mjs','guard.mjs'),('scripts/wo35-consumer-driver.mjs','driver.mjs'),('scripts/fixtures/packed-create-run-verify-v1.json','fixture.json')]:shutil.copy2(ROOT/source,instrumentation/name)
