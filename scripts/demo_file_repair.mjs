...
console.log('OFFLINE FILE REPAIR DEMO · installed Product · synthetic files · deterministic Faux');console.log(`Disposable snapshots and archives: ${root}`);
...
console.log('Picker: Tab/Shift-Tab or Up/Down navigate; Left/Right and Backspace edit grapheme clusters. Navigation never selects or sends.');
console.log('The prompt says Not submitted. Write a task if blank; a separate composer Enter sends.');
