...
assert.deepEqual(results[0].exports, results[1].exports, 'public named exports/type categories changed');
fs.writeFileSync(path.join(output, 'summary.json'), JSON.stringify({node: process.version, results}, null, 2) + '\n');
console.log('PASS identical public named exports and the same typed client against both installed tarballs');
