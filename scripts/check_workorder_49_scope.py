...
print(json.dumps({'base':base,'candidate':git('rev-parse','HEAD').decode().strip(),'criteria':'1.2','changed':sorted(changed),'protected':protected,'status':'PASS'},indent=2))
