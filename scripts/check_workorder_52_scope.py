...
for f in changed:assert f in readmes or f in new or f.startswith('typescript/src/config/') or f in {'scripts/demo_preview.mjs','scripts/fixtures/preview/config-boundary-driver.mjs','scripts/fixtures/preview/config-configure-driver.mjs','scripts/fixtures/preview/config-interactive-configure.mjs','scripts/fixtures/preview/config-keychain-driver.mjs','scripts/fixtures/preview/config-task-driver.mjs','scripts/fixtures/preview/interactive-driver.mjs'},f
protected={}
for f in old:
