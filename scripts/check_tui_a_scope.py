...
m=json.loads((root/'docs/design/workorder-tui-a-obligations.json').read_text());assert m['base']==base and m['criteria_version']=='1.0'
...
print(json.dumps({'base':base,'candidate_sha':git('rev-parse','HEAD').decode().strip(),'changed':changed,'protected':protected,'priorObligations':len(prior),'links':links},indent=2))
